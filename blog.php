					...
					<div class="row">
						<div id="primary" class="col-xs-12 col-md-9">
							...
							<article>
								...
								<h2 class="title">
									<a href="inlagg.html">Frukost</a>
								</h2>
								<ul class="meta">
									<li>
										<i class="fa fa-calendar"></i> 22 september, 2021
									</li>
									<li>
										<i class="fa fa-user"></i> <a href="http://localhost/grupprojekt/wordpress/wp-content/uploads/2021/09/cocktail-1971488_640.jpg">Produktinfo</a>
									</li>
							...
							<article>
								<img src="http://localhost/grupprojekt/wordpress/wp-content/uploads/2021/09/beverage-4908765_640.jpg" />
								<h2 class="title">
									<a href="inlagg.html">Milkshake</a>
								</h2>
								<ul class="meta">
									<li>
										<i class="fa fa-calendar"></i> 22 september, 2021
									...
									<li>
										<i class="fa fa-user"></i> <a href="http://localhost/grupprojekt/wordpress/wp-content/uploads/2021/09/cocktail-1971488_640.jpg">Milkshake info</a>
									</li>
							...
							<article>
								<img src="http://localhost/grupprojekt/wordpress/wp-content/uploads/2021/09/bamboo-1850195_640.jpg" />
								<h2 class="title">
									<a href="inlagg.html">Kaffe?!!!!!!</a>
								</h2>
								<ul class="meta">
									<li>
